...
import type { BackupUseCase, SyncResult } from '@atlas/types';
import type { VerificationUseCase, VerificationResult } from '@atlas/types';
import type { RestoreUseCase, RestoreResult } from '@atlas/types';
import type { CatalogUseCase, MailboxSummary } from '@atlas/types';
import type { DeletionUseCase, DeletionResult } from '@atlas/types';
import type { StorageCheckUseCase, StorageCheckResult } from '@atlas/types';
import type { SaveUseCase, SaveResult } from '@atlas/types';
...
beforeEach(async () => {
  vi.clearAllMocks();
  const mod = await import('@/atlas-instance.adapter');
